...
function DatePicker() {
  ...
  // 6. 输入框
  let myRefipt = useRef<HTMLInputElement>();
  ...
  return (
    <div
      ...
      // onBlur={divBlur}
    >
      <div className={focus ? [style.iptBox, style.iptBoxFocu].join(' ') : style.iptBox}>
        <input type="text" placeholder="请选择日期" ref={myRefipt} />
        <span>icon</span>
      </div>
      ...
      >
        <div className={style.sectionTop}>
          <header>
            <button className={style.leftBtnOne} onClick={upYear}>
              <span></span>
            </button>
            <button className={style.leftBtnTwo} onClick={upMath}>
              <span></span>
            </button>
            <div>
              <button className={style.yearBtn} style={{ marginRight: 5 }}>
                {year}年
              </button>
              <button className={style.monthBth}>{math}月</button>
            </div>
            <button className={style.rightBtnTwo} onClick={nextMath}>
              <span></span>
            </button>
            <button className={style.rightBtnOne} onClick={nextYear}>
              <span></span>
            </button>
          </header>
          <main>
